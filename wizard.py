...
Created by Wizard oussama on 06/07/2022.
...
|  `  '  | |  | |  /  ||  _  ||    \ |     |
 \      /  |  | |     ||  |  ||  .  \|     |
  \_/\_/  |____||_____||__|__||__|\_||_____|
     ...
     \x1b[1;97m Whatsapp  \033[31;1m:  \033[32m0701763164
     \x1b[1;97m
"""
...
print("\033[36;1m[\033[31;1m-\033[36;1m] \033[33;1mPlease Write Robot.txt Here👇👇👇\n")
...
def menu():
    try:
        ...
        print("\n\033[32;1m[\033[31;1m!\033[32;1m]\033[33;1m File wordlist \033[36;1m{} \033[33;1mNot Found\x1b[0m".format(pass)
        exit()
	
if __name__ == '__wizard__':
    try:
        wizard()
